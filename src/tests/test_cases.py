...
class TestCases:
    ...
    def test_case3(self, set_up_browser):
        ...
        repositories = driver.find_elements(By.CLASS_NAME, 'Box-sc-g0xbh4-0 cFPoqW')
        stars = driver.find_element(By.XPATH, "//*[contains(@aria-label,'stars')]").get_attribute("aria-label")
        stars = int(stars.split()[0])
        assert stars < 20000
