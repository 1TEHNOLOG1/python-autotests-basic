...
class TestCases:
    def test_case1(self, set_up_browser):
        ...
        with allure.step("Поиск результатов"):
            ...
            WebDriverWait(set_up_browser, 3).until(
                EC.presence_of_element_located((By.ID, "issue_223805_link"))
            )
        issues = driver.find_elements(By.XPATH, '//a[@data-hovercard-type="issue"]')
        with allure.step(
            'Проверка отображения задач, которое содержит "bug" в названии'
        ):
    ...
    def test_case2(self, set_up_browser):
        ...
        WebDriverWait(set_up_browser, 3).until(
            EC.presence_of_element_located((By.XPATH, "//*[@value = 'bpasero']"))
        )
    ...
    def test_case4(self, set_up_browser):
        ...
        with allure.step("Устновка диапазона до 12 месяцев"):
            ...
            actions.click_and_hold(el_2).move_by_offset(
        ...
        profession1 = driver.find_element(
            By.XPATH, "(//*[@class = 'ui-product-card-main__title t t--2'])[1]"
        ).text
        profession2 = driver.find_element(
            By.XPATH, "(//*[@class = 'ui-product-card-main__title t t--2'])[2]"
        ).text
